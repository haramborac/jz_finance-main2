...
<header>
    ...
    <script>
        ...
        <?php 
            ...
            while($row = mysqli_fetch_assoc($showtable_query)){
                ...
                // $updateOG = "UPDATE insert_client set cloanstatus = 'Finished' where cbalance = 0 and ";
                // mysqli_query($connection,$updateOG);
